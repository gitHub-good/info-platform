...
public class QuoteSourceAdapter extends AbstractSourceAdapter {
    ...
    private static final List<String> PROVIDERS = SourceProviders.providers(SourceCode.QUOTE);
    ...
    private Optional<RawFetch> fetchByProvider(Subject subject, String provider, String label)
        ...
        return switch (provider) {
            ...
            default -> throw new IllegalArgumentException("行情源未知 provider: " + provider);
        };
    }
