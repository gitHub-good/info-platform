 ...
 * com.info.platform.application.retention.RetentionCleanupService} 逐表分批循环清理（单表失败续跑 + 统计）、 {@link
 * com.info.platform.application.retention.RetentionCleanupJob} 第 7 个收编任务（ManagedJob + JobRunStats）。
 */
