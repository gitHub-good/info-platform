...
class SourceConfigValidatorTest {
    ...
    private static InfoSource rssSource(SourceConfig config, int intervalMinutes) {
        return InfoSource.create(
                "t100_v", "校验源", "媒体", AdapterType.RSS, null,
                "https://example.com/rss", config, intervalMinutes, true, false);
    }

    private static SourceConfig.ItemMapping mapping(String source, String target, String transform) {
    ...
    void validateCreate_rejectsPresetAndHtmlTemplateAdapterTypes() {
        InfoSource preset =
                InfoSource.create(
                        "t100_vp", "预置", "快讯", AdapterType.PRESET, "someBean",
                        "https://example.com/api", SourceConfig.empty(), 5, true, false);
        InfoSource html =
                InfoSource.create(
                        "t100_vh", "模板", "媒体", AdapterType.HTML_TEMPLATE, null,
                        "https://example.com/list", SourceConfig.empty(), 15, true, false);
    ...
    void validateCommon_rejectsNonHttpEndpoint() {
        InfoSource source =
                InfoSource.create(
                        "t100_vu", "源", "媒体", AdapterType.RSS, null, "ftp://example.com/rss",
        ...
        assertThatThrownBy(
                        () ->
                                validator.validateCommon(
                                        InfoSource.create(
                                                "t100_vi", "源", "媒体", AdapterType.RSS, null,
                                                "https://example.com/rss", SourceConfig.empty(), 0,
                                                true, false)))
    ...
    void validateCommon_jsonApiRequiresTitleMapping() {
        ...
        InfoSource source =
                InfoSource.create(
                        "t100_vj", "源", "快讯", AdapterType.JSON_API, null,
                        "https://example.com/api", noMapping, 5, true, false);
        assertThatThrownBy(() -> validator.validateCommon(source))
                .isInstanceOf(BusinessException.class)
        ...
        SourceConfig withTitle =
                new SourceConfig(
                        "", null, null,
                        List.of(mapping("title", "title", "to_string")), null, null, null, null,
                        null);
        InfoSource ok =
                InfoSource.create(
                        "t100_vj2", "源", "快讯", AdapterType.JSON_API, null,
                        "https://example.com/api", withTitle, 5, true, false);
    ...
    void validateCommon_unknownTransformRejected() {
        SourceConfig bad =
                new SourceConfig(
                        "", null, null,
                        List.of(mapping("title", "title", "explode")), null, null, null, null,
                        null);
        InfoSource source =
                InfoSource.create(
                        "t100_vt", "源", "快讯", AdapterType.JSON_API, null,
                        "https://example.com/api", bad, 5, true, false);
    ...
    void validateCommon_mappingFieldBlankRejected() {
        SourceConfig bad =
                new SourceConfig(
                        "", null, null, List.of(mapping(" ", "title", "to_string")), null, null,
                        null, null, null);
        InfoSource source =
                InfoSource.create(
                        "t100_vb", "源", "快讯", AdapterType.JSON_API, null,
                        "https://example.com/api", bad, 5, true, false);
    ...
    void validateCommon_headersWhitelistOnly() {
        ...
        SourceConfig withSecret =
                new SourceConfig(
                        null, null, null, List.of(), Map.of("Cookie", "session=abc"), null, null,
                        null, null);
        InfoSource source =
                InfoSource.create(
                        "t100_vh2", "源", "媒体", AdapterType.RSS, null,
                        "https://example.com/rss", withSecret, 15, true, false);
        assertThatThrownBy(() -> validator.validateCommon(source))
                .isInstanceOf(BusinessException.class)
        ...
        InfoSource ok =
                InfoSource.create(
                        "t100_vh3", "源", "媒体", AdapterType.RSS, null,
                        "https://example.com/rss", okHeaders, 15, true, false);
        assertThatCode(() -> validator.validateCommon(ok)).doesNotThrowAnyException();
    }
    ...
    void validateCommon_cursorDeclarationConsistency() {
        ...
        SourceConfig noField =
                new SourceConfig(null, null, null, List.of(), null, null, null, CursorType.ID,
                        null);
        InfoSource source =
                InfoSource.create(
                        "t100_vc", "源", "快讯", AdapterType.JSON_API, null,
                        "https://example.com/api", noField, 5, true, false);
        assertThatThrownBy(() -> validator.validateCommon(source))
                .isInstanceOf(BusinessException.class)
        ...
        SourceConfig redundant =
                new SourceConfig(null, null, null, List.of(), null, null, null, CursorType.NONE,
                        "externalId");
        InfoSource source2 =
                InfoSource.create(
                        "t100_vc2", "源", "快讯", AdapterType.JSON_API, null,
                        "https://example.com/api", redundant, 5, true, false);
    ...
    void validateCommon_numericBounds() {
        ...
        InfoSource source =
                InfoSource.create(
                        "t100_vn", "源", "媒体", AdapterType.RSS, null,
                        "https://example.com/rss", over, 15, true, false);
        assertThatThrownBy(() -> validator.validateCommon(source))
                .isInstanceOf(BusinessException.class)
        ...
        InfoSource source2 =
                InfoSource.create(
                        "t100_vn2", "源", "媒体", AdapterType.RSS, null,
                        "https://example.com/rss", pageSizeBad, 15, true, false);
        assertThatThrownBy(() -> validator.validateCommon(source2))
                .isInstanceOf(BusinessException.class)
