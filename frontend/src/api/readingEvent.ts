...
// POST /api/v1/reading-events（Bearer）：详情页/政策详情/简报页阅读事件上报，
// 供每日推荐的个性化相关性排序（已读标的热度 + 时间衰减）消费。
//
...
/** 阅读内容类型（对齐后端 ReadingEventType 枚举名）。 */
export type ReadingContentType = 'SUBJECT_DETAIL' | 'POLICY' | 'AI_BRIEF';
